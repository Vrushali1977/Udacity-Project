...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic["n_correct_dogs"] = sum([value[3] * value[4] for value in results_dic.values()])
    results_stats_dic["n_correct_notdogs"] = sum([(1 - value[3]) * (1 - value[4]) for value in results_dic.values()])
    results_stats_dic["n_correct_breed"] = sum([value[2] * value[3] * value[4] for value in results_dic.values()])    
